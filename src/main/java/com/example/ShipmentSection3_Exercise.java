...
class Shipment {
    ...
    // ✔ TODO A : แก้ if condition ให้ STANDARD ใช้ STANDARD_RATE
    //            และ EXPRESS ใช้ EXPRESS_RATE (สลับ logic เดิม)
    ...
    // ✔ TODO B : เติม toString() ให้แสดงผลตามรูปแบบ
    //            [RS001]  2.00 กก. | STANDARD |     80.00 บาท
    @Override
    public String toString() {
        return String.format("[%s]  %.2f กก. | %s |%10.2f บาท",
...
class ShippingCompany {
    ...
    // ✔ TODO C : แก้ index ให้ดึง shipments.get(i) แทน get(0)
    ...
    // ✔ TODO D : เติม loop แสดงรายการ shipment แต่ละตัว
    //            และบรรทัดแสดงยอดรวม
